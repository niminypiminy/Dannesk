use egui::{Ui, RichText, Color32, Stroke, Margin, TextEdit, Area, Align2, Vec2};
...
pub fn styled_text_edit(ui: &mut Ui, buffer: &mut String, is_dark_mode: bool, is_password: bool) -> egui::Response {
