// src/ui/managexrp/euro/modify/mod.rs
            ...
            Frame::popup(ui.style())
                ...
                .show(ui, |ui| {
                    ...
                    ui.with_layout(Layout::top_down(egui::Align::Center), |ui| {
                        styled_label(ui, "Modify EURO Trustline Limit", TITLE_SIZE, true, text_color);
                        ui.add_space(10.0);
                        ui.add_space(10.0);
                        ...
                        ui.with_layout(Layout::top_down(Align::Center), |ui| {
                            ...
                            let left_padding = base_padding + 25.0;
                        ...
                        ui.with_layout(Layout::top_down(Align::Center), |ui| {
                            ...
                            let base_padding = (max_width - total_content_width).max(0.0) / 2.0;
                            let left_padding = base_padding + 60.0;
                            let right_padding = base_padding.max(0.0);
