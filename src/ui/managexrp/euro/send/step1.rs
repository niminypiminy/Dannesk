// src/ui/managexrp/euro/send/step1.rs
...
pub fn render_step1(
    ...
    ui.add_space(10.0);
    // Center the button to match rlusd/step1.rs
    ui.allocate_ui_with_layout(
        egui::Vec2::new(150.0, 40.0), // Size for button area, matches rlusd/step1
        egui::Layout::top_down(egui::Align::Center),
        |ui| {
            // Modernized Next button to match rlusd/step1
            ...
            Frame::default() // egui 0.31.1, no ID argument
                .inner_margin(Margin::symmetric(8, 4)) // Matches rlusd/step1
                .show(ui, |ui| {
                    // Dynamic button size based on modal width (350.0 from mod.rs)
                    let button_width = 100.0 * (ui.available_width() / 350.0).min(1.2).max(0.8); // Matches rlusd/step1
