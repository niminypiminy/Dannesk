// src/ui/managexrp/euro/send/buffer_manager.rs
...
impl BufferManager {
    ...
    pub fn update_euro_amount(&mut self, euro_amount: &str) {
        self.euro_amount_buffer = euro_amount.to_string();
        self.update_buffers();
    }
    ...
    pub fn euro_amount_buffer(&self) -> &str {
        &self.euro_amount_buffer
    }
