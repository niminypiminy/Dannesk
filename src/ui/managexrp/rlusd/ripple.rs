...
pub fn render(ui: &mut Ui) -> bool {
    ...
    Area::new(egui::Id::new("ripple_overlay"))
        .fixed_pos(pos)
        ...
        .show(ui.ctx(), |ui| {
            ...
            Frame::popup(ui.style())
                ...
                .show(ui, |ui| {
                    ...
                    Area::new(egui::Id::new("ripple_close_button"))
                    ...
                    ui.allocate_ui_with_layout(
                        ...
                        |ui| {
                            ...
                            ui.add_space(5.0);
                            ui.label(
                                RichText::new("The RLUSD token is pegged to the dollar. It's owned and managed by Ripple.")
                                    .size(14.0)
                                    .color(text_color),
                            );
                            ui.add_space(10.0);
