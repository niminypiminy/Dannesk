// src/ui/managexrp/rlusd/step3.rs
use egui::{Ui, Margin, Color32, RichText, Frame, Grid};
use crate::channel::{CHANNEL, SendRLUSDTransaction, SendRLUSDTransactionState, ProgressState, WSCommand};
...
pub fn validate_and_submit_transaction(
    ...
    } else if let Ok(amount) = trimmed_usd_amount.parse::<f64>() {
        if amount <= 0.0 {
            ...
            let command = WSCommand {
                ...
                amount: Some(trimmed_usd_amount.to_string()),
                passphrase,
                seed,
                ...
                taker_gets: None,
                flags: None,
                wallet_type: Some("RLUSD".to_string()),
            };
            ...
            ui.vertical(|ui| {
                ...
                Grid::new("transaction_details_grid")
                    ...
                    .show(ui, |ui| {
                        ...
                        ui.label(
                            RichText::new(format!("${:.2}", buffer_manager.usd_amount_buffer()))
                                .size(14.0)
                                .color(text_color),
                        );
                        ui.end_row();
