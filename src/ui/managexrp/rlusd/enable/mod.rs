// src/ui/managexrp/rlusd/enable/mod.rs
            ...
            Frame::popup(ui.style())
                ...
                .show(ui, |ui| {
                    ...
                    ui.with_layout(Layout::top_down(egui::Align::Center), |ui| {
                        styled_label(ui, "Enable RLUSD Trustline", TITLE_SIZE, true, text_color);
                        ui.add_space(10.0);
                        styled_label(
                            ui,
                            "This will establish an RLUSD trustline with a default limit of 1,000,000 RLUSD. The xrpl blockchain will reserve 0.20 XRP for the trustline. You can modify the trustline limit after activation.",
                            SUBTEXT_SIZE,
                            false,
                            text_color,
                        );
