...
use crate::channel::{XRPImport, XRPModalState, ActiveView, WSCommand}; // Add WSCommand import
use tokio::sync::mpsc;
...
pub fn view(ui: &mut Ui, import_state: &mut XRPImport, commands_tx: mpsc::Sender<WSCommand>) -> bool {
