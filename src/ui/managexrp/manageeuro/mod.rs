...
pub fn render_manage_euro() -> Element {
    ...
    let on_submit = move |_| {
        ...
        // Reset fields after submit to match xrpsend behavior
...
rsx! {
    div {
        // Enforce border-box and vertical alignment for the whole screen
        style: "display: flex; flex-direction: column; width: 100%; align-items: center; box-sizing: border-box;",
        
        if !has_euro {
            // Tabs - Synchronized spacing and rounded border
            div {
            ...
            div {
                ...
                h3 { 
                    ...
                    "Enabling a trustline is required to send and receive EUROP."
                    br {}
            ...
            div {
                ...
                if input_mode() == "seed" {
                    ...
                    // Passphrase View: BIP39 comes first
