...
impl BufferManager {
    ...
    pub fn update_xrp_amount(&mut self, xrp_amount: &str) {
        self.xrp_amount_buffer = xrp_amount.to_string();
        self.update_buffers();
    }
    ...
    pub fn xrp_amount_buffer(&self) -> &str {
        &self.xrp_amount_buffer
    }
