...
pub fn MarketOrderForm(
    ...
    let deviation = if market_rate > 0.0 { ((price_f - market_rate) / market_rate) * 100.0 } else { 0.0 };
    ...
    rsx! {
        style { {r#"
            ...
            .market-rate-readout { font-size: 0.7rem; color: var(--text-secondary); letter-spacing: 1px; white-space: nowrap; }
        ...
        div { class: "trade-step-container",
            ...
            div { class: "input-section row-grid",
                ...
                div {
                    ...
                    if is_manual() && abs_dev > 1.0 {
                        div { class: "market-rate-readout", style: "color: orange; margin-top: 0.5rem;",
            ...
            // --- OFFER PREMIUM ---
            div { class: "input-section",
                div { class: "input-label-row", div { class: "input-label", "OFFER PREMIUM (%)" } }
