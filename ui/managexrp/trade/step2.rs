...
("LIMIT_PRICE_PER_UNIT".to_string(), format!("{limit_price} {quote_asset}")),  // changed label
// Optional: add total cost for clarity
("TOTAL_COST".to_string(), format!("{:.4} {quote_asset}", 
